    ...
    function apply(ctx) {
      ...
      slots.inject('conversation.input.left', () => slots.register(
        ...
        (props) => {
          ...
          const dotTip = vision === null ? '正在检测视觉模型连接…' : (vision.detail || vision.status) + (vision.model ? ' · ' + vision.model : '')
          ...
          const statusBadge = React.createElement('span', {
            ...
            title: dotTip,
            style: { display: 'inline-flex', alignItems: 'center', gap: 4, cursor: 'pointer', padding: '1px 6px', borderRadius: 10, background: 'rgba(127,127,127,.12)', fontSize: 11, lineHeight: '16px', color: 'inherit', flex: 'none' }
          },
          ...
          return React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 6, marginRight: 2 } },
            ...
            React.createElement(Tooltip, { label: dotTip, side: 'top' }, statusBadge),
