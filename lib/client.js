        ...
        (props) => {
          ...
          const statusBadge = React.createElement('span', {
            ...
            React.createElement('span', {
              ...
              React.createElement('span', { style: { fontSize: 7, marginLeft: 1, color: 'inherit', opacity: 0.6 }, children: '▾' })
            ),
            dropdownOpen && React.createElement('div', {
              style: { position: 'absolute', top: 'calc(100% + 4px)', left: 0, zIndex: 1000, background: 'var(--dsw-specific-menu, #fff)', border: '1px solid var(--dsw-alias-border-l2, #e0e0e0)', borderRadius: 8, boxShadow: '0 4px 12px rgba(0,0,0,0.12)', minWidth: 200, maxHeight: 240, overflow: 'auto', padding: 4 }
            },
